...
package/%.xdc.inc package/%_sylink_test.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package sylink_test" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedsylink_testpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js sylink_test $@
...
.PHONY: release,sylink_test
sylink_test.zip: package/package.bld.xml
sylink_test.zip: package/build.cfg
sylink_test.zip: package/package.xdc.inc
sylink_test.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/sylink_test.zip.dep
endif
package/rel/sylink_test/sylink_test/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

sylink_test.zip: package/rel/sylink_test.xdc.inc package/rel/sylink_test/sylink_test/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/sylink_test.xdc.inc,package/rel/sylink_test.zip.dep)


release release,sylink_test: all sylink_test.zip
clean:: .clean
	-$(RM) sylink_test.zip
	-$(RM) package/rel/sylink_test.xdc.inc
	-$(RM) package/rel/sylink_test.zip.dep
